...
/*/{Protheus.doc} User Function L10E05
    Adicionar um novo botão que vai gerar um  relatório com todos os pedidos existentes
    @type  Function
...
Static Function GeraReport()
	...
	Local oReport	:= TReport():New('L10E05', 'Relatório de Pedidos de Compra',,{|oReport| Imprime(oReport, cAlias)}, 'Esse relatório imprimirá os Pedidos de Compra',.F.)	
	
	Local oSection	:= TRSection():New(oReport, "Cabeçalho do Pedido")	
